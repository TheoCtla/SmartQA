/**
 * Service de scraping pour SmartQA
 * Extrait le contenu et les liens des sites Webflow
 */
 ...
 * @param {string} baseUrl - URL de base pour résoudre les liens relatifs
 */
...
async function scrapeWebsite(startUrl, maxPages = 20) {
    ...
    while (toVisit.length > 0 && visited.size < maxPages) {
        ...
        try {
            ...
            const { textes, liens, liensExternes, metaTitle, metaDescription } = extractContentFromHtml(html, url);
